...
from datasets.sdf_dataset import SDFDataset, SDFDataset_RGB, SDFDataset_RGBD
...
class Tester(Base):
    ...
    def _make_batch_generator(self):
        ...
        if cfg.task == 'hsdf_osdf_1net' or cfg.task == 'hsdf_osdf_2net' or cfg.task == 'hsdf_osdf_2net_pa':
            #self.testset_loader = SDFDataset_RGB(testset3d_db, cfg=cfg, mode='test')
            self.testset_loader = SDFDataset_RGBD(testset3d_db, cfg=cfg, mode='test')
        elif 'sdf_base' in cfg.task or'sdf_pcl' in cfg.task:
