...
class dexycb:
    ...
    def load_video_data(self):
        ...
        for aid in self.split:
            ...
            if 'train' in self.stage_split:
                sample['sdf_hand_path'] = os.path.join(self.cur_dir, 'data',  'sdf_hand', sample['id'] + '.npz')
                sample['sdf_obj_path'] = os.path.join(self.cur_dir, 'data',  'sdf_obj', sample['id'] + '.npz')
    ...
    def _evaluate(self, output_path, idx):
        ...
        gt_hand_mesh_path = os.path.join(self.cur_dir, 'data', 'mesh_hand', sample_idx + '.obj')
        try:
        ...
        gt_obj_mesh_path = os.path.join(self.cur_dir, 'data', 'mesh_obj', sample_idx + '.obj')
        try:
